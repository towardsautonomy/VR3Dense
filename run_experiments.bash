...
if [ "$MODE" == "train" ]; then
    ...
    if [ "$OPTION" == "ablation" ]; then
        ...
        python train.py --dataroot=/media/shubham/GoldMine/datasets/KITTI/object_trainval \
	...
	# test
    python test.py --pc_dir /media/shubham/GoldMine/datasets/KITTI/raw/2011_09_26/2011_09_26_drive_0009_sync/velodyne_points/data \
                   --img_dir /media/shubham/GoldMine/datasets/KITTI/raw/2011_09_26/2011_09_26_drive_0009_sync/image_02/data \
	...
	# evaluate
    python src/compute_precision_recall.py --dataroot=/media/shubham/GoldMine/datasets/KITTI/object_trainval \
